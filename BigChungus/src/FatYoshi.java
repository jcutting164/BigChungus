...
public class FatYoshi extends Enemy implements Serializable {
    ...
    public FatYoshi(float x, float y, float height, float width, Handler handler, Game game, ID id, int speed, TBHandler tbHandler, String text, Player player, boolean battleReady){
        super(x, y, height, width,handler,game, id, speed, tbHandler, "YOSHI!", player,ID.FatYoshi,10,10);
        ...
        this.health = 20;
        setName("Fat Yoshi");
        this.nameColor = Color.green.darker();
...
// to be replaced
       /* this.walkLeft = new Animation(speed, tex.Pikachu_WalkLeft[0], tex.Pikachu_WalkLeft[1], tex.Pikachu_WalkLeft[2]);
        ...
        this.BattleForm = tex.FatYoshiBF;
    }
