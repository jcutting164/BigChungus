...
public class Crab extends Enemy implements Serializable {
    ...
    /* edit text bubble, ID, name, nameColor, stats*/


    public Crab(float x, float y, float height, float width, Handler handler, Game game, ID id, int speed, TBHandler tbHandler, String text, Player player, boolean battleReady){
        super(x, y, height, width,handler,game, id, speed, tbHandler, "SNIP", player,ID.Crab,12,15);
        ...
        this.health = 25;
        setName("Rave Crab");
        this.nameColor = Color.red.brighter();
