...
public class BongoCat extends Enemy implements Serializable {
    ...
    public BongoCat(float x, float y, float height, float width, Handler handler, Game game, ID id, int speed, TBHandler tbHandler, String text, Player player, boolean battleReady){
        super(x, y, height, width,handler,game, id, speed, tbHandler, "Tap tap tap", player,ID.BongoCat,10,10);
...
// to be replaced
       /* this.walkLeft = new Animation(speed, tex.Pikachu_WalkLeft[0], tex.Pikachu_WalkLeft[1], tex.Pikachu_WalkLeft[2]);
        ...
        // EDIT THIS//////////////////////////////////////
        this.BattleForm = tex.BongoCatBF;
    }
