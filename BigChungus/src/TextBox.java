...
public class TextBox extends GameObject implements Serializable {
    ...
    public TextBox(Character character, String text,float x, float y, float height, float width, ID id,TBHandler tbHandler) {
...
// splits up text into parts
    ...
    public void tick(){
        if(interacted||tbHandler.contains(this)){
        ...
        if(interacted||tbHandler.contains(this)){
            ...
            if(!(this.character==null)){
                if(this.character.getId()==ID.Knuckles){
                    ...
                    g.drawImage(this.character.Face, 130, 800,126, 126, null);
