...
public class Kermit extends Enemy implements Serializable {
    ...
    public Kermit(float x, float y, float height, float width, Handler handler, Game game, ID id, int speed, TBHandler tbHandler, String text, Player player, boolean battleReady){
        super(x, y, height, width,handler,game, id, speed, tbHandler, "That's the tea", player,ID.Kermit,20,20);
